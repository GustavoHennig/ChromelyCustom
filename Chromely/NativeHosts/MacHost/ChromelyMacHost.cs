...
namespace Chromely.NativeHost
{
    public partial class ChromelyMacHost : IChromelyNativeHost
    {
        ...
        {
            Console.WriteLine("ShutdownCallback");
            CefRuntime.Shutdown();
        }
        ...
        protected virtual void QuitCallback()
        {
            try
            {
                ...
                { 
                    Console.WriteLine("!CefRuntime.CurrentlyOn(CefThreadId.UI)");
                }
                Console.WriteLine("QuitCallback");
                //CefRuntime.Shutdown();
                Console.WriteLine("QuitCallback Shutdown");
                HostClose?.Invoke(this, new CloseEventArgs());
                Console.WriteLine("QuitCallback HostClose?.Invoke");
                Environment.Exit(0);
            }
